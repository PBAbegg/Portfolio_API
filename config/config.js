...
const database = {
    ...
    buildConnectionString: () => {
        ...
        //node process takes all metadata and creates a global variable called process. process controls all that is in our app.
...
//es6 provides simplification to key value pairs (database: database)
module.exports = {
    database
}
